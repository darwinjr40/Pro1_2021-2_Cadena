 ...
 cadena = class
    private
     ...
     public
       ...
       //Adiciona un String al objeto
       //var pos=='hola'           AddPal(pos)
       //var pos=='hola'           pos='como';
       //concaena una nueva palabra al objeto
       procedure AddPal(pal :String);
       //Inserta en una posicion un character (2,'X')
       ...
       //Elimina una palabra de todo el objeto
       ...
       //división de una Cadena en dos Cadenas a partir de una palabra X, la palabra X formará parte de la Primer Cadena.
       procedure ejercicio1(cad2 :cadena;pal: String);
       procedure Invertir();
       procedure ejercicio6(cad1,cad2:String);
       //permite intercalar las palabras de dos cadenas en una tercera
       procedure ejercicio6(cad1,cad2:cadena);
       //invierte las palabras del objeto
       function invertirPal():String;
       procedure ConverMayus();
       function Verif_primo(pos:integer):String;
       procedure ejercicio10(pal:String);
       // elimina todas las palabras repetidas
       procedure delPalabrasRepetidas();
       //cantidad de caracteres del objeto ignora espacios
